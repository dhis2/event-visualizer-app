...
How your work reaches the human: this sandbox publishes its repository back to the host over a read-only git remote, and the human fetches your branch from it to review — so committing to your branch is all that is needed.
