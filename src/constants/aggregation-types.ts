...
export const aggregationTypeDisplayNames: Record<AggregationType, string> = {
    ...
    AVERAGE_SUM_ORG_UNIT: i18n.t('Average (sum in org unit hiararchy)'),
    LAST: i18n.t('Last value'),
    LAST_AVERAGE_ORG_UNIT: i18n.t('Last value (sum in org unit hiararchy)'),
    LAST_LAST_ORG_UNIT: i18n.t('Last value (last in org unit hierarchy)'),
    LAST_IN_PERIOD: i18n.t('Last value in period'),
    LAST_IN_PERIOD_AVERAGE_ORG_UNIT: i18n.t(
        'Last value in period (sum in org unit hierarchy'
    ),
    FIRST: i18n.t('First'),
    FIRST_AVERAGE_ORG_UNIT: i18n.t('First value (sum in org unit hierarchy'),
