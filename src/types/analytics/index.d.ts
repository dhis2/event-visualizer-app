...
import type { DeleteDialog } from './delete-dialog'
import type { FileMenu } from './file-menu'
import type { GetLinkDialog } from './get-link-dialog'
...
import type { OpenFileDialog } from './open-file-dialog'
...
declare module '@dhis2/analytics' {
    ...
    export const GetLinkDialog: GetLinkDialog
