import { DimensionCard } from '@components/sidebar/dimension-card'
import { EVENT_WITH_REGISTRATION_FIXED_DIMENSION_TYPES } from '@components/sidebar/get-event-fixed-dimensions'
import { computeIsDisabledByFilter } from '@components/sidebar/use-dimension-list'
import { getDataElementQueryTemplate } from '@components/sidebar/use-dimension-list/query-helpers'
import {
